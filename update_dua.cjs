...
const target1 = `{/* iOS-Inspired Reading Top Bar */}
      <div 
        ...
        {!showTopBar && lastScrollY > 200 && (
          ...
          >
            <button
              ...
              className="w-12 h-12 bg-purple-600 hover:bg-purple-700 text-white shadow-lg rounded-2xl flex items-center justify-center transition-all active:scale-95"
