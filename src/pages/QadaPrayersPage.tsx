  ...
  return (
    <div dir="rtl" className="space-y-5 max-w-6xl mx-auto pb-28 md:pb-12 select-none">
      ...
      <Portal>
        ...
        >
          <Card className="p-3.5 border border-neutral-200/90 dark:border-neutral-800/80 shadow-xl bg-surface-card/95 backdrop-blur-md">
            <div className="grid grid-cols-3 items-center">
              {/* SECTION 1 (RIGHT in RTL): تعداد نمازهای قضا */}
              <div className="flex items-center gap-2 justify-start pr-1">
                ...
                <div className="flex flex-col">
                  <div className="flex items-baseline gap-1">
                    <span className="text-base font-extrabold text-emerald-600 dark:text-emerald-400 leading-none">
                      {formatPersianNumber(totalRemaining)}
                    </span>
